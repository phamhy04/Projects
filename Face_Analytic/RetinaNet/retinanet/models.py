...
class Features(nn.Module):
    def __init__(self, feature_size=256):
        ...
        self.conv2 = nn.Conv2d(64, feature_size, kernel_size=3, stride=2, padding=1, bias=False)
        self.bn2 = nn.BatchNorm2d(feature_size)

        self.conv3 = nn.Conv2d(feature_size, feature_size, kernel_size=3, stride=2, padding=1, bias=False)
        self.bn3 = nn.BatchNorm2d(feature_size)

        self.conv4 = nn.Conv2d(feature_size, feature_size, kernel_size=3, stride=2, padding=1, bias=False)
